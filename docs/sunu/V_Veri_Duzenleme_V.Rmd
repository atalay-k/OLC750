...
- Gördüğünüz gibi, şimdi iki sütunumuz var: Biri *Sure* için, diğeri **Zaman** için. Her katılımcı icin üç farklı süre değeri olduğu için her bir ID değeri üç kere tekrarlamaktadır.
...
- **spread():**  **gather*()** fonksiyonun tam tersini yaparak uzun veriden geniş veri oluşturmaya yarar.
...
Veri [seti üzerinde](data/DATA2.csv) [soruları](dplyrsorular.pdf) cevaplayınız.
